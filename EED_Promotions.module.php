...
class EED_Promotions extends EED_Module {
		...
		if ( $event instanceof EE_Event ) {
			...
			foreach ( $active_promotions as $promotion ) {
				if ( $promotion instanceof EE_Promotion ) {
					...
					$redeemable_scope_promos = $promotion->scope_obj()->get_redeemable_scope_promos( $promotion, true, $event );
	 ...
	 * @throws \EE_Error
	 */
	public function get_applicable_items( EE_Promotion $promotion, EE_Cart $cart, $suppress_notices = true, $get_events = false ) {
