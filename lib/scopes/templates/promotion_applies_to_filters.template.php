...
<div class='ee-promotions-applies-to-filters'>
    <h3 class='ee-promotions-applies-to-filters__heading'>
        ...
        <span class="dashicons dashicons-admin-settings ee-toggle-filters"
    ...
    <div class="ee-promotions-filter-settings"<?php echo $show_filters; ?>>
        ...
        <div>
            ...
            <?php echo EEH_Form_Fields::select_input('EVT_CAT_ID', $categories, $default); ?>
        </div>
        ...
        <button class="button secondary-button right" id="ee-apply-promotion-filter"><?php esc_html_e(
                'Apply',
                'event_espresso'
            ); ?></button>
